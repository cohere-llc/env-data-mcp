...
DEFAULT_SOIL_PROFILE_VARIABLES: frozenset[str] = frozenset(
    [
...
DEFAULT_AREA_SUMMARY_VARIABLES: frozenset[str] = frozenset(
    [
        ...
        # Available water storage 0–150 cm: limits plant productivity → organic C inputs
        "aws0150wta",
        ...
        # Non-irrigated capability class: overall productivity rating for site comparison
        "niccdcd",
    ]
)
...
DEFAULT_SUBSURFACE_BARRIERS_VARIABLES: frozenset[str] = frozenset(
    [
        ...
        "taxsubgrp",
        # Slope gradient: with a subsurface barrier, controls lateral flow of perched water
        "slope_r",
    ]
)
...
DEFAULT_SEASONAL_HYDROLOGY_VARIABLES: frozenset[str] = frozenset(
    [
        ...
        # Flooding frequency: how often flooding occurs → episodic community-resetting anaerobic
        # events
        "flodfreqcl",
        # Flooding duration: how long flood events persist → magnitude and severity of anaerobic
        # pulse
        "floddurcl",
        ...
        "dlyavgprecip_r",
        # Daily potential ET [mm]: monthly moisture loss; net precip–ET balance sets saturation
        # duration
        "dlyavgpotet_r",
    ]
)
...
DEFAULT_SOIL_SUITABILITY_RULE_NAMES: frozenset[str] = frozenset(
    [
        ...
        # Inorganic C stock: completes C budget; carbonate-cycling microbial pathways and pH
        # uffering
        ...
        # Risk of OM loss under land use change: predicts vulnerability of microbial C substrate
        # pool
        ...
        # Organic compound mobility to groundwater: proxy for DOC and nutrient leaching to
        # subsurface
...
DEFAULT_ECOLOGICAL_SITE_VARIABLES: frozenset[str] = frozenset(
    [
        # compname, comppct_r, ecoclassid, ecoclassname are always present
        # --- Ecological classification metadata ---
        # Classification type (rangeland/forest/non-site): sets vegetation community context for C
        # input
        "ecoclasstypename",
        # Reference to ESIS description: look-up of plant community, production, and disturbance
        # data
        "ecoclassref",
...
DEFAULT_PARENT_MATERIAL_VARIABLES: frozenset[str] = frozenset(
    [
        ...
        "pmorder",
        # Top depth [cm]: upper bound of this PM layer's mineral weathering and nutrient-release
        # zone
        "pmdept_r",
        # Bottom depth [cm]: lower bound; full thickness of PM influence on rooting, microbial
        # habitat
        "pmdepb_r",
        # --- Textural/compositional refinement ---
        # Textural modifier (gravelly/silty/etc.): pore size, water retention, and habitat
        # heterogeneity
        "pmmodifier",
        # General modifier: broader compositional descriptor (e.g. organic vs mineral character of
        # PM)
        "pmgenmod",
    ]
)
...
DEFAULT_SOIL_TEMPERATURE_VARIABLES: frozenset[str] = frozenset(
    [
        ...
        "taxtempregime",
        # MAAT [°C]: air-soil coupling; MAST offset indicates organic/snow insulation of soil
        # profile
        "airtempa_r",
...
AVAIL_SQL_TABLES: MappingProxyType[QueryType, tuple[str, ...]] = MappingProxyType(
    {
