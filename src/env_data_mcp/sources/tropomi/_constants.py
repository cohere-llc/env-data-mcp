...
PRODUCT_TYPES: MappingProxyType[ProductType, str] = MappingProxyType(
    {
...
UNITS_MAP: MappingProxyType[str, str] = MappingProxyType(
    {
        "L2_CH4": "ppb",
        "L2_SO2": "mol m-2",
        "L2_AER_AI": "unitless",
...
GDAL_OPTS: MappingProxyType[str, str] = MappingProxyType(
    {
