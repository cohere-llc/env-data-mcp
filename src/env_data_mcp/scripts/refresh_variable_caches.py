...
def get_registry() -> dict[str, VariableCacheEntry]:
    ...
    from env_data_mcp.sources.soilgrids import _var_cache  # noqa: F401, F811
    from env_data_mcp.sources.ssurgo import _var_cache  # noqa: F401, F811
    from env_data_mcp.sources.tropomi import _var_cache  # noqa: F401, F811
